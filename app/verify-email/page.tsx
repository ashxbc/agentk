...
const Spinner = () => (
  <>
    <svg style={{ animation: "spin .8s linear infinite" }} width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="#DF849D" strokeWidth="2.5">
  ...
  return (
    <div style={{
      ...
      <div style={cardStyle}>
        ...
        {/* Logo */}
        <img src="/logo.png" alt="AgentK" style={{ height: 32, width: "auto", marginBottom: 32 }} />
        ...
        {status === "expired" && (
          <>
            ...
            <a href="/dashboard" style={btnStyle}>Go to dashboard</a>
          </>
        )}

        {status === "invalid" && (
          <>
            <p style={{ fontSize: 15, fontWeight: 800, color: "#191918", margin: "0 0 8px" }}>Already verified</p>
            <p style={{ fontSize: 13, color: "#62584F", margin: "0 0 24px" }}>
              Your email is already verified. Head to your dashboard.
            </p>
            <a href="/dashboard" style={btnStyle}>Go to dashboard</a>
          </>
        )}
